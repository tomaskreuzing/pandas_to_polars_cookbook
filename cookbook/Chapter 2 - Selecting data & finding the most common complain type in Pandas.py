...
#%%
complaint_counts = pl_complaints.select("Complaint Type")
complaint_counts = complaint_counts.to_series()
complaint_counts = complaint_counts.value_counts(sort=True)
top_complaints = complaint_counts[:10]
print(top_complaints)
#%%
top_complaints_s = top_complaints.to_series()
print(top_complaints_s)
plt.bar(top_complaints_s.to_list(), height=10000)
